...
abstract class Driver
{
     ...
     */
    public abstract function loadParameters($parameters);

    /**
     * Connect to the database
     * @param Database $database
     */
    public abstract function connect(Database $database);
     ...
     * @return string[]
     */
    public abstract function getTables(Database $database);
     ...
     * @return string
     */
    public abstract function getColumnSQLExpression(Column $column);
     ...
     * @return mixed
     */
    public abstract function getColumnDenormalizedValue(Column $column, $value);
    ...
    {
        return new Hydrator($this, $table, $query, $asArray);
    }
